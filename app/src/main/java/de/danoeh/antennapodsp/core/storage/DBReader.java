package de.danoeh.antennapodsp.core.storage;
...
import de.danoeh.antennapodsp.core.util.comparator.DownloadStatusComparator;
import de.danoeh.antennapodsp.core.util.comparator.FeedItemPubdateComparator;
import de.danoeh.antennapodsp.core.util.comparator.PlaybackCompletionDateComparator;
 ...
 * This class will use the {@link de.danoeh.antennapodsp.core.feed.EventDistributor} to notify listeners about changes in the database.
 */
public final class DBReader {
     ...
     * can be loaded separately with {@link #getFeedItemList(android.content.Context, de.danoeh.antennapodsp.core.feed.Feed)}.
     */
     ...
     * list in a {@link de.danoeh.antennapodsp.core.util.QueueAccess} object for easier access to the queue's properties.
     */
     ...
     * {@link #getFeedItemList(android.content.Context, de.danoeh.antennapodsp.core.feed.Feed)} if only metadata about
