package de.danoeh.antennapodsp.core.service.playback;
...
import de.danoeh.antennapodsp.core.feed.MediaType;
import de.danoeh.antennapodsp.core.preferences.UserPreferences;
import de.danoeh.antennapodsp.core.receiver.MediaButtonReceiver;
import de.danoeh.antennapodsp.core.util.playback.AudioPlayer;
import de.danoeh.antennapodsp.core.util.playback.IPlayer;
import de.danoeh.antennapodsp.core.util.playback.Playable;
import de.danoeh.antennapodsp.core.util.playback.VideoPlayer;
...
public class PlaybackServiceMediaPlayer {
     ...
     *
     * @see #playMediaObject(de.danoeh.antennapodsp.core.util.playback.Playable, boolean, boolean, boolean)
     */
    ...
    private void seekToSync(int t) {
        if (t < 0) {
            if (BuildConfig.DEBUG) Log.d(TAG, "Received invalid value for t");
            return;
        }
        playerLock.lock();
